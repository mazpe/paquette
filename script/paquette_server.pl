...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{PAQUETTE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{PAQUETTE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
paquette_server.pl - Catalyst Testserver

=head1 SYNOPSIS

paquette_server.pl [options]
